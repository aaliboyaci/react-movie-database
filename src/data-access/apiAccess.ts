...
export async function getMovieCastDetails(
  show_id: string | undefined,
): Promise<MovieCastDetailsDTO> {
  try {
...
export async function getPersonPopMovies(
  personId: string | undefined,
): Promise<PersonPopMoviesDTO> {
  try {
...
export async function getSearchPerson(
  page: number,
  query: string,
): Promise<SearchPersonDTO[]> {
  try {
