...
const PersonPage: React.FC = () => {
  ...
  return (
    <div className="containerPP">
      ...
      <img
        className="imagePP"
        src={`${posterBaseUrl}${personData?.profilPath}`}
        alt={personData?.name}
      ...
      <p className="infoPP">
        {" "}
        <b>Known for:</b> {personData?.knownForDepartment}
      </p>
      {personData?.birthday && (
        <p className="infoPP">
          <b>Birthday:</b> {personData.birthday}
        </p>
      )}
      <p className="infoPP">
        <b>Gender :</b> {personData?.gender === 1 ? <>Woman</> : <>Man</>}
      </p>
      ...
      {personData?.website && (
        <p className="infoPP">
          <a href={personData?.website} target="_blank">
      ...
      {personData?.birthday && (
        <div className="bioPP">
          ...
          {isExpanded
            ...
            : `${personData.biography.slice(0, 200)}...`}
          <br></br>
          <br></br>
